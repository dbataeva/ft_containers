...
int main () {
	...
	std::map<std::string, double> b(++a.begin(), --a.end());

	std::cout << "### construction by copy\n";
	std::map<std::string, double> c(a);

	std::cout << "### operator=\n";
	c = b;

	std::cout << "### begin for iterator\n";
	std::map<std::string, double>::iterator d = b.begin();
	std::cout << d->first << " " << d->second << std::endl;

	std::cout << "### begin for const_iterator\n";
	std::map<std::string, double>::const_iterator e = c.begin();
	std::cout << e->first << " " << e->second << std::endl;

	std::cout << "### construction by copy for iterators\n";
	std::map<std::string, double>::iterator g(d);
	std::cout << g->first << " " << g->second << std::endl;

	std::cout << "### construction by copy for const_iterators\n";
	std::map<std::string, double>::const_iterator h(e);
	std::cout << h->first << " " << h->second << std::endl;

	std::cout << "### construction by copy for const_iterator(iterator)\n";
	std::map<std::string, double>::const_iterator f(d);
	...
	std::pair<const std::string, double> k = *i;
	std::cout << k.first << " " << k.second << std::endl;

	std::cout << "### operator* for const_iterator\n";
	std::pair<const std::string, double> l = *j;
	...
	std::map<std::string, double>::reverse_iterator p = a.rbegin();
	...
	std::map<std::string, double>::const_reverse_iterator r = a.rend();
	...
	std::map<std::string, double>::reverse_iterator q(p);
	std::cout << q->first << " " << q->second << std::endl;

	std::cout << "### construction by copy for const_reverse_iterator\n";
	std::map<std::string, double>::const_reverse_iterator s(r);
	...
	std::map<std::string, double>::iterator zz = a.begin();
	std::map<std::string, double>::const_iterator xx = --a.end();
	std::map<std::string, double>::reverse_iterator yy = a.rbegin();
	std::map<std::string, double>::const_reverse_iterator ww = --a.rend();
	...
	std::pair<std::map<std::string, double>::iterator, bool> u = a.insert(std::pair<std::string, double>("999", 6.6));
	...
	u = a.insert(std::pair<std::string, double>("qwertyuiop", 5.5));
	std::cout << (u.first)->first << " " << (u.first)->second << " " << u.second << std::endl;
	std::cout << zz->first << " " << zz->second << std::endl;
	std::cout << xx->first << " " << xx->second << std::endl;
	std::cout << yy->first << " " << yy->second << std::endl;
	...
	d = a.insert(a.begin(), std::pair<std::string, double>("a", 5.5));
	std::cout << d->first << " " << d->second << std::endl;
	std::cout << zz->first << " " << zz->second << std::endl;
	std::cout << xx->first << " " << xx->second << std::endl;
	std::cout << yy->first << " " << yy->second << std::endl;
	...
	std::cout << "### key_comp\n";
	std::map<std::string, double>::key_compare v = a.key_comp();
	std::cout << v("okn", "ijn") << std::endl;

	std::cout << "### value_comp\n";
	std::map<std::string, double>::value_compare w = a.value_comp();
	std::cout << w(std::pair<std::string, double>("uhb", 1.1), std::pair<std::string, double>("ygv", 0.0)) << std::endl;
	...
	std::map<std::string, double>::const_iterator x = t.find("zxcvbnm");
	...
	std::pair<std::map<std::string, double>::iterator, std::map<std::string, double>::iterator> y = t.equal_range("a");
	std::cout << y.first->first << " " << y.first->second << " " << y.second->first << " " << y.second->second << std::endl;

	std::cout << "### equal_range for const_iterators\n";
	std::pair<std::map<std::string, double>::const_iterator, std::map<std::string, double>::const_iterator> z;
	...
	std::map<std::string, double>::allocator_type aa = t.get_allocator();
	std::pair<const std::string, double> *bb = aa.allocate(1);
	const std::string cc("0147");
	aa.construct(bb, std::pair<const std::string, double>(cc, 5.0));
