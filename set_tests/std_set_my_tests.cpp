...
int main () {
	...
	std::set<std::string> b(a.begin(), a.end());
	...
	std::set<std::string>::iterator e = a.begin();
	std::cout << *e << std::endl;
	...
	std::set<std::string>::const_iterator f = a.begin();
	std::cout << *f << std::endl;
	...
	std::set<std::string>::iterator g = a.end();

	std::cout << "### end() const_itrerator\n";
	std::set<std::string>::const_iterator h = a.end();
	...
	std::set<std::string>::reverse_iterator o = a.rend();
	...
	std::set<std::string>::const_reverse_iterator q = a.rbegin();
	...
	std::set<std::string>::const_reverse_iterator r = a.rend();
	std::set<std::string>::reverse_iterator s = a.rbegin();
	...
	std::set<std::string>::reverse_iterator t;
	(void)t;
	...
	std::set<std::string>::reverse_iterator v(++s);
	std::cout << *v << std::endl;

	std::cout << "### construction by copy for const_reverse_iterator(const_reverse_iterator)\n";
	std::set<std::string>::const_reverse_iterator w(--r);
	std::cout << *w << std::endl;

	std::cout << "### construction by copy for const_reverse_iterator(reverse_iterator)\n";
	std::set<std::string>::const_reverse_iterator y(++s);
	std::cout << *y << std::endl;

	std::cout << "### construction by copy for const_reverse_iterator(reverse_iterator)\n";
	std::set<std::string>::const_reverse_iterator x(++s);
	std::cout << *x << std::endl;
	...
	std::set<std::string>::iterator z = a.insert(++a.begin(), "qaz");
	std::cout << *z << std::endl;

	std::cout << "### insert for value\n";
	std::pair<std::set<std::string>::iterator, bool> aa = a.insert("wsx");
	std::cout << aa.second << std::endl;

	std::cout << "### insert for range\n";
	for (std::set<std::string>::iterator bb = a.begin(); bb != a.end(); ++bb) {
	...
	std::cout << "### key_copm\n";
	std::set<std::string>::key_compare bb = a.key_comp();
	std::cout << bb.operator()("aaa", "aaab") << std::endl;

	std::cout << "### value_copm\n";
	std::set<std::string>::value_compare dd = a.value_comp();
	...
	std::pair<std::set<std::string>::iterator, std::set<std::string>::iterator> ee = a.equal_range("rfv");
	for (; ee.first != ee.second; ++ee.first) {
		std::cout << *ee.first << std::endl;
	}

	std::cout << "### get_allocator\n";
	std::set<std::string>::allocator_type ff = a.get_allocator();
	...
	for (std::set<std::string>::iterator gg = a.begin(); gg != a.end(); ++gg) {
		std::cout << *gg << std::endl;
	}
	for (std::set<std::string>::iterator gg = b.begin(); gg != b.end(); ++gg) {
		std::cout << *gg << std::endl;
	}
	swap(a, b);
	for (std::set<std::string>::iterator gg = a.begin(); gg != a.end(); ++gg) {
