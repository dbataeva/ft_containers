...
int main () {
	...
	ft::vector<std::string> b(100, "qwerty");
	...
	ft::vector<std::string> *d = new ft::vector<std::string> (100, "asdfg") ;
	...
	const ft::vector<std::string> e(c);
	...
	ft::vector<std::string>::iterator start_a = a.begin();
	ft::vector<std::string>::iterator start_c = c.begin();
	...
	std::cout << "=== TEST REVERSE_ITERATOR ===" << std::endl;
	{
		...
		ft::vector<std::string>::reverse_iterator start = c.rbegin();
		std::cout << *start << std::endl;

		std::cout << "=== test const_reverse_iterator && rbegin() && operator* with not const string ===" << std::endl;
		ft::vector<std::string>::const_reverse_iterator st = c.rbegin();

		std::cout << "=== test reverse_iterator && rend() && operator* ===" << std::endl;
		ft::vector<std::string>::reverse_iterator finish = c.rend();
		(void)finish;

		std::cout << "ok\n=== test const_reverse_iterator && rend() && operator* with not const string ===" << std::endl;
		ft::vector<std::string>::const_reverse_iterator finis = c.rend();
		(void)finis;
		...
		ft::vector<std::string>::reverse_iterator i_copy(start);
		...
		ft::vector<std::string>::const_reverse_iterator c_i_cop(start);
		...
		ft::vector<std::string>::reverse_iterator fi = c.rend();
		...
		*start = "00000";
		...
		ft::vector<std::string>::const_reverse_iterator st_ = st + 1;
	...
	std::cout << ft::equal(a.begin(), a.end(), c.begin()) << std::endl;

	std::cout << "=== test equal(iterator1, iterator2, iterator3) ===" << std::endl;
	std::cout << ft::equal(a.begin(), a.end(), a.begin()) << std::endl;

	std::cout << "=== test equal(iterator1, iterator2, iterator3, pred) ===" << std::endl;
	std::cout << ft::equal(a.begin(), a.end(), c.begin(), my_pred) << std::endl;

	std::cout << "=== test equal(iterator1, iterator2, iterator3, pred) ===" << std::endl;
	std::cout << ft::equal(a.begin(), a.end(), a.begin(), my_pred) << std::endl;

	std::cout << "=== test lexicographical_compare (iterator1, iterator2, iterator3, itertor4) ===" << std::endl;
	std::cout << ft::lexicographical_compare(a.begin(), a.end(), c.begin(), c.end()) << std::endl;

	std::cout << "=== test lexicographical_compare (iterator1, iterator2, iterator3, itertor4) ===" << std::endl;
	std::cout << ft::lexicographical_compare(a.begin(), a.end(), a.begin(), a.end()) << std::endl;

	std::cout << "=== test construction vector(iteratot first, iterator last)" << std::endl;
	ft::vector<std::string>::iterator start = c.begin();
	ft::vector<std::string>::iterator finish = c.end();
	ft::vector<std::string> k(start, finish);
	...
	try{
		ft::vector<std::string> k(finish, start);
	}
	catch (std::exception &e) {
		std::cout << e.what() << std::endl;
	}
	...
	ft::vector<std::string>::reverse_iterator star = c.rbegin();
	ft::vector<std::string>::reverse_iterator finis = c.rend();
	ft::vector<std::string> l(star, finis);
	std::cout << c[0] << " " << c[99] << std::endl;
	...
	try{
		ft::vector<std::string> l(finis, star);
	}
	catch (std::exception &e) {
		std::cout << e.what() << std::endl;
	}
	...
	ft::vector<std::string>::iterator i_m = c.begin();
	i_m += 10;
	...
	ft::vector<std::string>::iterator i_e = c.end();
