...
int main () {
	...
	unsigned int start_time =  clock();
	{
		...
		ft::vector<std::string>::const_iterator st = c.begin();
		...
		ft::vector<std::string>::const_iterator finis = c.end();
		(void)finis;
		...
		ft::vector<std::string>::iterator i_copy(start);
		...
		ft::vector<std::string>::const_iterator c_i_cop(start);
		...
		ft::vector<std::string>::iterator fi = c.end();
		...
		*start = "00000";
		...
		ft::vector<std::string>::iterator z = start + 3;
		std::cout << "start + 3: " << *z << std::endl;
		
		std::cout << "=== test operator+ for const_iterator ===" << std::endl;
		std::cout << "st: " << *st << std::endl;
		ft::vector<std::string>::const_iterator y = st + 2;
		...
		const ft::vector<std::string> t(40, "skjdnf");
		ft::vector<std::string>::const_iterator j = t.begin();
		(void)j;
