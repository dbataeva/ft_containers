...
int main () {
	...
	std::cout << "### swap ###\n";
	{
		...
		std::vector<int>::iterator zz = foo.begin();
		std::vector<int>::const_iterator yy = --foo.end();
		std::vector<int>::reverse_iterator xx = bar.rbegin();
		std::vector<int>::const_reverse_iterator ww = --bar.rend();
	...
	std::cout << "### rend\n";
	{
		...
		std::vector<int>::const_reverse_iterator c_it = myvector.rbegin();
...

	{
		...
		std::vector<int> first;                    // empty


		std::vector<int> second;  // empty using vector
		std::vector<int> third (myvector);
		std::vector<int>::reverse_iterator i_t = third.rbegin();
